// Pedro Stamm 2020-08 (my contribution to Stamm-Reis algorithm)
// New version (8192 markers)
// White border: 0 to 4095 
// Black border: 4096 to 8191
// 0 represents the white color (0: white, 1 black)

// Test example:
//<button onclick="stammReis().markerCreationAndDecodingFullTest(456)">Creation and decoding test</button>
//<button onclick="stammReis().srDecodeImageExample()">Test</button>
...
var stammReis = function () {
    ...
    function srDecodeImageExample() {
        ...
        show("1101000111101011000000110"); // marker number 4709 black border (613 with inverted colors) (without border bits)
